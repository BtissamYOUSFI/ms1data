...
import ma.zyn.app.ws.facade.admin.profil.NiveauLangueRestAdmin;
...
public class NiveauLangueRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private NiveauLangueAdminServiceImpl service;
    @Mock
    private NiveauLangueConverter converter;

    @InjectMocks
    private NiveauLangueRestAdmin controller;
