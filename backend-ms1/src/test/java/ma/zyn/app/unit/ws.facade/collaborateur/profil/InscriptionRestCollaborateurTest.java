...
import ma.zyn.app.ws.facade.collaborateur.profil.InscriptionRestCollaborateur;
...
public class InscriptionRestCollaborateurTest {

    private MockMvc mockMvc;

    @Mock
    private InscriptionCollaborateurServiceImpl service;
    @Mock
    private InscriptionConverter converter;

    @InjectMocks
    private InscriptionRestCollaborateur controller;
