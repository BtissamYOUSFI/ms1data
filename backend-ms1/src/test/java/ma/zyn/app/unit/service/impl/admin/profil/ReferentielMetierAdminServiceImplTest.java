...
@SpringBootTest
class ReferentielMetierAdminServiceImplTest {

    @Mock
    private ReferentielMetierDao repository;
    private AutoCloseable autoCloseable;
    private ReferentielMetierAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ReferentielMetierAdminServiceImpl(repository);
    }
