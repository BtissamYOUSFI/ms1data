...
import ma.zyn.app.service.impl.collaborateur.profil.LangueCollaborateurServiceImpl;
import ma.zyn.app.ws.facade.collaborateur.profil.LangueRestCollaborateur;
...
public class LangueRestCollaborateurTest {

    private MockMvc mockMvc;

    @Mock
    private LangueCollaborateurServiceImpl service;
    @Mock
    private LangueConverter converter;

    @InjectMocks
    private LangueRestCollaborateur controller;
