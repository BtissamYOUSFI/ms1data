...
@SpringBootTest
class NiveauLangueCollaborateurServiceImplTest {

    @Mock
    private NiveauLangueDao repository;
    private AutoCloseable autoCloseable;
    private NiveauLangueCollaborateurServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new NiveauLangueCollaborateurServiceImpl(repository);
    }
