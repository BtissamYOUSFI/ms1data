...
@SpringBootTest
class MoyenPaiementCollaborateurServiceImplTest {

    @Mock
    private MoyenPaiementDao repository;
    private AutoCloseable autoCloseable;
    private MoyenPaiementCollaborateurServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new MoyenPaiementCollaborateurServiceImpl(repository);
    }
