...
import ma.zyn.app.service.impl.collaborateur.transaction.PaiementCollaborateurServiceImpl;
import ma.zyn.app.ws.facade.collaborateur.transaction.PaiementRestCollaborateur;
...
public class PaiementRestCollaborateurTest {

    private MockMvc mockMvc;

    @Mock
    private PaiementCollaborateurServiceImpl service;
    @Mock
    private PaiementConverter converter;

    @InjectMocks
    private PaiementRestCollaborateur controller;
