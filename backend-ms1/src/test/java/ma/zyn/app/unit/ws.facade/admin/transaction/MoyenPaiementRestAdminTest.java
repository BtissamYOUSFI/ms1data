...
import ma.zyn.app.ws.facade.admin.transaction.MoyenPaiementRestAdmin;
...
public class MoyenPaiementRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private MoyenPaiementAdminServiceImpl service;
    @Mock
    private MoyenPaiementConverter converter;

    @InjectMocks
    private MoyenPaiementRestAdmin controller;
