...
import ma.zyn.app.ws.facade.collaborateur.accompagnement.EtatReunionRestCollaborateur;
...
public class EtatReunionRestCollaborateurTest {

    private MockMvc mockMvc;

    @Mock
    private EtatReunionCollaborateurServiceImpl service;
    @Mock
    private EtatReunionConverter converter;

    @InjectMocks
    private EtatReunionRestCollaborateur controller;
