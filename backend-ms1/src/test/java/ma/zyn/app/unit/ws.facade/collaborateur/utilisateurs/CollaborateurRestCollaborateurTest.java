package ma.zyn.app.unit.ws.facade.collaborateur.utilisateurs;

import ma.zyn.app.bean.core.utilisateurs.Collaborateur;
import ma.zyn.app.service.impl.collaborateur.utilisateurs.CollaborateurCollaborateurServiceImpl;
import ma.zyn.app.ws.facade.collaborateur.utilisateurs.CollaborateurRestCollaborateur;
...
public class CollaborateurRestCollaborateurTest {

    private MockMvc mockMvc;

    @Mock
    private CollaborateurCollaborateurServiceImpl service;
    @Mock
    private CollaborateurConverter converter;

    @InjectMocks
    private CollaborateurRestCollaborateur controller;
