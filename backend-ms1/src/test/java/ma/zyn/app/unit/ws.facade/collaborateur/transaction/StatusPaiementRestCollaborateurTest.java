...
import ma.zyn.app.ws.facade.collaborateur.transaction.StatusPaiementRestCollaborateur;
...
public class StatusPaiementRestCollaborateurTest {

    private MockMvc mockMvc;

    @Mock
    private StatusPaiementCollaborateurServiceImpl service;
    @Mock
    private StatusPaiementConverter converter;

    @InjectMocks
    private StatusPaiementRestCollaborateur controller;
