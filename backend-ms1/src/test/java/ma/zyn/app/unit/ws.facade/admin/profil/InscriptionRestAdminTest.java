...
import ma.zyn.app.service.impl.admin.profil.InscriptionAdminServiceImpl;
import ma.zyn.app.ws.facade.admin.profil.InscriptionRestAdmin;
...
public class InscriptionRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private InscriptionAdminServiceImpl service;
    @Mock
    private InscriptionConverter converter;

    @InjectMocks
    private InscriptionRestAdmin controller;
    ...
    public void itShouldSaveInscriptionTest() throws Exception {
        ...
        assertEquals(savedDto.getNombreHeureExperience(), responseBody.getNombreHeureExperience());
    }
