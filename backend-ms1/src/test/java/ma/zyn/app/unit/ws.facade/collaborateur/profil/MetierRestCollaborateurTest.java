...
import ma.zyn.app.ws.facade.collaborateur.profil.MetierRestCollaborateur;
...
public class MetierRestCollaborateurTest {

    private MockMvc mockMvc;

    @Mock
    private MetierCollaborateurServiceImpl service;
    @Mock
    private MetierConverter converter;

    @InjectMocks
    private MetierRestCollaborateur controller;
