...
@Service
public class TemplateEmailCollaboratorManagerServiceImpl implements TemplateEmailCollaboratorManagerService {
    ...
    public TemplateEmailCollaboratorManagerServiceImpl(TemplateEmailCollaboratorDao dao) {
        this.dao = dao;
    }
