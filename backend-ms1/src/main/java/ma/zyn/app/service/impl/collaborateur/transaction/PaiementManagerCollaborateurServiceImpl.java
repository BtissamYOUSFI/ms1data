...
@Service
public class PaiementManagerCollaborateurServiceImpl implements PaiementManagerCollaborateurService {
    ...
    public PaiementManagerCollaborateurServiceImpl(PaiementManagerDao dao) {
        this.dao = dao;
    }
