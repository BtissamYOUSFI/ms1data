...
import java.util.List;
@Service
public class NiveauLangueCollaborateurServiceImpl implements NiveauLangueCollaborateurService {
    ...
    public NiveauLangueCollaborateurServiceImpl(NiveauLangueDao dao) {
        this.dao = dao;
    }
