package ma.zyn.app.service.impl.manager.utilisateurs;
...
@Service
public class CollaborateurManagerServiceImpl implements CollaborateurManagerService {
    ...
    public CollaborateurManagerServiceImpl(CollaborateurDao dao) {
        this.dao = dao;
    }
