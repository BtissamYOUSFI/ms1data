...
import java.util.List;
@Service
public class StatusPaiementCollaborateurServiceImpl implements StatusPaiementCollaborateurService {
    ...
    public StatusPaiementCollaborateurServiceImpl(StatusPaiementDao dao) {
        this.dao = dao;
    }
