package ma.zyn.app.service.impl.collaborateur.accompagnement;
...
import ma.zyn.app.service.facade.collaborateur.utilisateurs.ManagerCollaborateurService ;
import ma.zyn.app.bean.core.utilisateurs.Manager ;

import java.util.List;
@Service
public class ReunionCollaborateurServiceImpl implements ReunionCollaborateurService {
    ...
    public List<Reunion> findByManagerId(Long id){
    ...
    @Autowired
    private EtatReunionCollaborateurService etatReunionService ;
    @Autowired
    private CollaborateurCollaborateurService collaborateurService ;
    @Autowired
    private ManagerCollaborateurService managerService ;

    public ReunionCollaborateurServiceImpl(ReunionDao dao) {
        this.dao = dao;
    }
