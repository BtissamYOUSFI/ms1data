...
import java.util.List;
@Service
public class EtatInscriptionCollaborateurServiceImpl implements EtatInscriptionCollaborateurService {
    ...
    public EtatInscriptionCollaborateurServiceImpl(EtatInscriptionDao dao) {
        this.dao = dao;
    }
