...
import ma.zyn.app.service.facade.manager.profil.LangueManagerService;
import ma.zyn.app.service.facade.manager.profil.MetierManagerService;
import ma.zyn.app.service.facade.manager.profil.NiveauLangueManagerService;
import ma.zyn.app.service.facade.manager.profil.ReferentielMetierManagerService;
...
@Service
public class ReferentielMetierManagerServiceImpl implements ReferentielMetierManagerService {
    ...
    public List<ReferentielMetier> findByMetierCode(String code){
        return (List<ReferentielMetier>) dao.findByMetierCode(code);
    }
    ...
    @Autowired
    private MetierManagerService metierService ;
    @Autowired
    private NiveauLangueManagerService niveauLangueService ;
    @Autowired
    private LangueManagerService langueService ;

    public ReferentielMetierManagerServiceImpl(ReferentielMetierDao dao) {
        this.dao = dao;
    }
