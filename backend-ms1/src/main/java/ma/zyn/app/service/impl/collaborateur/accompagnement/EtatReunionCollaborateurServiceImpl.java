...
import java.util.List;
@Service
public class EtatReunionCollaborateurServiceImpl implements EtatReunionCollaborateurService {
    ...
    public EtatReunionCollaborateurServiceImpl(EtatReunionDao dao) {
        this.dao = dao;
    }
