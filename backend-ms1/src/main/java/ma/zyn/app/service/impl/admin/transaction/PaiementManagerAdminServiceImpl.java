...
@Service
public class PaiementManagerAdminServiceImpl implements PaiementManagerAdminService {
    ...
    @Autowired
    private StatusPaiementAdminService statusPaiementService ;
    @Autowired
    private ManagerAdminService managerService ;

    public PaiementManagerAdminServiceImpl(PaiementManagerDao dao) {
        this.dao = dao;
    }
