...
@RestController
@RequestMapping("/api/collaborateur/referentielMetier/")
public class ReferentielMetierRestCollaborateur {
   ...
   public ReferentielMetierRestCollaborateur(ReferentielMetierCollaborateurService service, ReferentielMetierConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReferentielMetierCollaborateurService service;
