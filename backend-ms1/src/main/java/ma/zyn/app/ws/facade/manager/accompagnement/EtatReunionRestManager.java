...
@RestController
@RequestMapping("/api/manager/etatReunion/")
public class EtatReunionRestManager {
   ...
   public EtatReunionRestManager(EtatReunionManagerService service, EtatReunionConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final EtatReunionManagerService service;
