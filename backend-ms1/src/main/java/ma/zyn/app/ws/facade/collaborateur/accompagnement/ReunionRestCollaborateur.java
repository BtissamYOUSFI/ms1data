...
import ma.zyn.app.service.facade.collaborateur.accompagnement.ReunionCollaborateurService;
...
@RestController
@RequestMapping("/api/collaborateur/reunion/")
public class ReunionRestCollaborateur {
    ...
    public ReunionRestCollaborateur(ReunionCollaborateurService service, ReunionConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReunionCollaborateurService service;
