...
@RestController
@RequestMapping("/api/collaborateur/statusPaiement/")
public class StatusPaiementRestCollaborateur {
   ...
   public StatusPaiementRestCollaborateur(StatusPaiementCollaborateurService service, StatusPaiementConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final StatusPaiementCollaborateurService service;
