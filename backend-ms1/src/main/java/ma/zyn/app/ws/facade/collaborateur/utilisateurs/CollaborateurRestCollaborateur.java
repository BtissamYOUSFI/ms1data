package  ma.zyn.app.ws.facade.collaborateur.utilisateurs;
...
@RestController
@RequestMapping("/api/collaborateur/collaborateur/")
public class CollaborateurRestCollaborateur {
   ...
   public CollaborateurRestCollaborateur(CollaborateurCollaborateurService service, CollaborateurConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CollaborateurCollaborateurService service;
