...
@RestController
@RequestMapping("/api/manager/niveauLangue/")
public class NiveauLangueRestManager {
   ...
   public NiveauLangueRestManager(NiveauLangueManagerService service, NiveauLangueConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final NiveauLangueManagerService service;
