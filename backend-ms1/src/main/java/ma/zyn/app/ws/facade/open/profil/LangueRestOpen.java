...
@RestController
@RequestMapping("/api/open/langue/")
public class LangueRestOpen {
   ...
   public LangueRestOpen(LangueAdminService service, LangueConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final LangueAdminService service;
