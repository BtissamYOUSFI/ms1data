...
import ma.zyn.app.service.facade.manager.accompagnement.TemplateEmailCollaboratorManagerService;
...
@RestController
@RequestMapping("/api/manager/templateEmailCollaborator/")
public class TemplateEmailCollaboratorRestManager {
   ...
   public TemplateEmailCollaboratorRestManager(TemplateEmailCollaboratorManagerService service, TemplateEmailCollaboratorConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final TemplateEmailCollaboratorManagerService service;
