package ma.zyn.app.ws.facade.collaborateur.transaction;
...
import ma.zyn.app.service.facade.collaborateur.transaction.PaiementManagerCollaborateurService;
...
@RestController
@RequestMapping("/api/collaborateur/paiementManager/")
public class PaiementManagerRestCollaborateur {
   ...
   public PaiementManagerRestCollaborateur(PaiementManagerCollaborateurService service, PaiementManagerConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PaiementManagerCollaborateurService service;
