...
@RestController
@RequestMapping("/api/manager/metier/")
public class MetierRestManager {
   ...
   public MetierRestManager(MetierManagerService service, MetierConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final MetierManagerService service;
