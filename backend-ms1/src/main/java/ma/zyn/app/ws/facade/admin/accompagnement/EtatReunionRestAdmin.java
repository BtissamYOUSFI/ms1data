...
@RestController
@RequestMapping("/api/admin/etatReunion/")
public class EtatReunionRestAdmin {
   ...
   public EtatReunionRestAdmin(EtatReunionAdminService service, EtatReunionConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final EtatReunionAdminService service;
