package ma.zyn.app.ws.facade.admin.utilisateurs;
...
public class ManagerRestAdmin {
   ...
   public ManagerRestAdmin(ManagerAdminService service, ManagerConverter converter){
