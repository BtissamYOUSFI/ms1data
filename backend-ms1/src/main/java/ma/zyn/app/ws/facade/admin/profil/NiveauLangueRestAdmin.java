...
@RestController
@RequestMapping("/api/admin/niveauLangue/")
public class NiveauLangueRestAdmin {
   ...
   public NiveauLangueRestAdmin(NiveauLangueAdminService service, NiveauLangueConverter converter){
