...
@RestController
@RequestMapping("/api/collaborateur/paiement/")
public class PaiementRestCollaborateur {
    ...
    public PaiementRestCollaborateur(PaiementCollaborateurService service, PaiementConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PaiementCollaborateurService service;
