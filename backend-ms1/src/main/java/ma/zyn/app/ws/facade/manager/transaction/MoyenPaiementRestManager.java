...
@RestController
@RequestMapping("/api/manager/moyenPaiement/")
public class MoyenPaiementRestManager {
   ...
   public MoyenPaiementRestManager(MoyenPaiementManagerService service, MoyenPaiementConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final MoyenPaiementManagerService service;
