package ma.zyn.app.ws.facade.manager.accompagnement;
...
import ma.zyn.app.service.facade.manager.accompagnement.ReunionManagerService;
...
@RestController
@RequestMapping("/api/manager/reunion/")
public class ReunionRestManager {
    ...
    public List<ReunionDto> findByCollaborateurId(@PathVariable Long id){
    ...
    @Operation(summary = "find by manager id")
    @GetMapping("manager/id/{id}")
    public List<ReunionDto> findByManagerId(@PathVariable Long id){
        return findDtos(service.findByManagerId(id));
    }
    @Operation(summary = "delete by manager id")
    @DeleteMapping("manager/id/{id}")
    public int deleteByManagerId(@PathVariable Long id){
        return service.deleteByManagerId(id);
    }
   ...
   public ReunionRestManager(ReunionManagerService service, ReunionConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReunionManagerService service;
