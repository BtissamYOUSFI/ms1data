...
import ma.zyn.app.service.facade.admin.profil.InscriptionAdminService;
...
@RestController
@RequestMapping("/api/open/inscription/")
public class InscriptionRestOpen {
    ...
    public ResponseEntity<InscriptionDto> save(@RequestBody InscriptionDto dto) throws Exception {
        if(dto!=null){
            ...
            Inscription t = collaborateurService.create(myT);
            if (t == null) {
   ...
   public InscriptionRestOpen(InscriptionAdminService service, InscriptionConverter converter, InscriptionCollaborateurService collaborateurService){
    ...
    private final InscriptionAdminService service;
    private final InscriptionConverter converter;
    private final InscriptionCollaborateurService collaborateurService;
