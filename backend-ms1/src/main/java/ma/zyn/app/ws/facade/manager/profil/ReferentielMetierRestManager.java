...
@RestController
@RequestMapping("/api/manager/referentielMetier/")
public class ReferentielMetierRestManager {
    ...
    public List<ReferentielMetierDto> findByNiveauLangueCode(@PathVariable String code){
   ...
   public ReferentielMetierRestManager(ReferentielMetierManagerService service, ReferentielMetierConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final ReferentielMetierManagerService service;
