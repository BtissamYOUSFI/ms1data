...
@RestController
@RequestMapping("/api/collaborateur/moyenPaiement/")
public class MoyenPaiementRestCollaborateur {
   ...
   public MoyenPaiementRestCollaborateur(MoyenPaiementCollaborateurService service, MoyenPaiementConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final MoyenPaiementCollaborateurService service;
