...
@RestController
@RequestMapping("/api/manager/paiement/")
public class PaiementRestManager {
   ...
   public PaiementRestManager(PaiementManagerService service, PaiementConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PaiementManagerService service;
