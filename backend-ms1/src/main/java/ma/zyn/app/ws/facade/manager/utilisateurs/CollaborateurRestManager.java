...
@RestController
@RequestMapping("/api/manager/collaborateur/")
public class CollaborateurRestManager {
   ...
   public CollaborateurRestManager(CollaborateurManagerService service, CollaborateurConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final CollaborateurManagerService service;
