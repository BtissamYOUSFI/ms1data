...
@RestController
@RequestMapping("/api/admin/statusPaiement/")
public class StatusPaiementRestAdmin {
   ...
   public StatusPaiementRestAdmin(StatusPaiementAdminService service, StatusPaiementConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final StatusPaiementAdminService service;
