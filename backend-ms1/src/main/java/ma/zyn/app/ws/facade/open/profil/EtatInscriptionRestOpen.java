...
@RestController
@RequestMapping("/api/open/etatInscription/")
public class EtatInscriptionRestOpen {
   ...
   public EtatInscriptionRestOpen(EtatInscriptionAdminService service, EtatInscriptionConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final EtatInscriptionAdminService service;
