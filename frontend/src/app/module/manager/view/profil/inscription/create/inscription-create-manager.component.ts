...
@Component({
  selector: 'app-inscription-create-manager',
  standalone: false,
  templateUrl: './inscription-create-manager.component.html'
})
export class InscriptionCreateManagerComponent  implements OnInit {
