...
import {ReunionManagerService} from "../../../../../../shared/service/manager/accompagnement/ReunionManager.service";


@Component({
  selector: 'app-inscription-list-manager',
  standalone: false,
  templateUrl: './inscription-list-manager.component.html'
})
export class InscriptionListManagerComponent implements OnInit {
    ...
    constructor(private reunionService: ReunionManagerService, private service: InscriptionManagerService  , private metierService: MetierManagerService, private niveauLangueService: NiveauLangueManagerService, private etatInscriptionService: EtatInscriptionManagerService, private langueService: LangueManagerService, private collaborateurService: CollaborateurManagerService, @Inject(PLATFORM_ID) private platformId?) {
