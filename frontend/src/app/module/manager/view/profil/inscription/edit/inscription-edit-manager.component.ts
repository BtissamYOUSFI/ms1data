...
@Component({
  selector: 'app-inscription-edit-manager',
  standalone: false,
  templateUrl: './inscription-edit-manager.component.html'
})
export class InscriptionEditManagerComponent implements OnInit {
