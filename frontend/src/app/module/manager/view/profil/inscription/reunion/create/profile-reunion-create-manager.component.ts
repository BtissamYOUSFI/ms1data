...
import {
    TemplateEmailCollaboratorManagerService
} from "../../../../../../../shared/service/manager/accompagnement/TemplateEmailCollaboratorManager.service";
@Component({
  selector: 'app-reunion-create-manager',
  standalone: false,
  templateUrl: './profile-reunion-create-manager.component.html'
})
export class ProfileReunionCreateManagerComponent implements OnInit {
   ...
   private _validReunionCode = true;
	...
	constructor(private emailCollaboratorService: TemplateEmailCollaboratorManagerService,private service: ReunionManagerService , private etatReunionService: EtatReunionManagerService, private collaborateurService: CollaborateurManagerService, private managerService: ManagerManagerService, @Inject(PLATFORM_ID) private platformId? ) {
