...
@Component({
  selector: 'app-metier-view-manager',
  standalone: false,
  templateUrl: './metier-view-manager.component.html'
})
export class MetierViewManagerComponent implements OnInit {
    ...
    constructor(private service: MetierManagerService){
