...
@Component({
  selector: 'app-referentiel-metier-create-manager',
  standalone: false,
  templateUrl: './referentiel-metier-create-manager.component.html'
})
export class ReferentielMetierCreateManagerComponent  implements OnInit {
