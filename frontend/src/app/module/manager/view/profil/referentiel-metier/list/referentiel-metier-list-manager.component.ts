...
@Component({
  selector: 'app-referentiel-metier-list-manager',
  standalone: false,
  templateUrl: './referentiel-metier-list-manager.component.html'
})
export class ReferentielMetierListManagerComponent implements OnInit {
