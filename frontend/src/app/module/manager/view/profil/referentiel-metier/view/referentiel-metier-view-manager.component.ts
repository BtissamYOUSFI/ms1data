...
@Component({
  selector: 'app-referentiel-metier-view-manager',
  standalone: false,
  templateUrl: './referentiel-metier-view-manager.component.html'
})
export class ReferentielMetierViewManagerComponent implements OnInit {
    ...
    constructor(private service: ReferentielMetierManagerService, private metierService: MetierManagerService, private niveauLangueService: NiveauLangueManagerService, private langueService: LangueManagerService){
