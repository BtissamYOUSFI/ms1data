...
@Component({
  selector: 'app-langue-view-manager',
  standalone: false,
  templateUrl: './langue-view-manager.component.html'
})
export class LangueViewManagerComponent implements OnInit {
    ...
    constructor(private service: LangueManagerService){
