...
@Component({
  selector: 'app-niveau-langue-list-manager',
  standalone: false,
  templateUrl: './niveau-langue-list-manager.component.html'
})
export class NiveauLangueListManagerComponent implements OnInit {
