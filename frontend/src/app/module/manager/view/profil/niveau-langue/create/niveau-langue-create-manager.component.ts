...
@Component({
  selector: 'app-niveau-langue-create-manager',
  standalone: false,
  templateUrl: './niveau-langue-create-manager.component.html'
})
export class NiveauLangueCreateManagerComponent  implements OnInit {
