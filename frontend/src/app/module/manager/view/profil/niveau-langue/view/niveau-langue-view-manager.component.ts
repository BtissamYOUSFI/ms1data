...
@Component({
  selector: 'app-niveau-langue-view-manager',
  standalone: false,
  templateUrl: './niveau-langue-view-manager.component.html'
})
export class NiveauLangueViewManagerComponent implements OnInit {
    ...
    constructor(private service: NiveauLangueManagerService){
