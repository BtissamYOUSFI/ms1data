...
@Component({
  selector: 'app-etat-reunion-edit-manager',
  standalone: false,
  templateUrl: './etat-reunion-edit-manager.component.html'
})
export class EtatReunionEditManagerComponent implements OnInit {
