...
@Component({
  selector: 'app-etat-reunion-list-manager',
  standalone: false,
  templateUrl: './etat-reunion-list-manager.component.html'
})
export class EtatReunionListManagerComponent implements OnInit {
