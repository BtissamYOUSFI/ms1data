...
@Component({
  selector: 'app-reunion-list-manager',
  standalone: false,
  templateUrl: './reunion-list-manager.component.html'
})
export class ReunionListManagerComponent implements OnInit {

    protected fileName = 'Reunion';
    ...
    etatReunions: Array<EtatReunionDto>;
    managers: Array<ManagerDto>;


    constructor( private service: ReunionManagerService  , private etatReunionService: EtatReunionManagerService, private collaborateurService: CollaborateurManagerService, private managerService: ManagerManagerService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    ngOnInit(): void {
        ...
        this.loadEtatReunion();
        this.loadManager();

    }

    isManager(element: any): boolean {
        return element.manager?.email === this.authService.authenticatedUser?.email;
    }
    ...
    public async edit(dto: ReunionDto) {
    ...
    public async view(dto: ReunionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ReunionDto) {
    ...
    public async duplicate(dto: ReunionDto) {
    ...
    public exportPdf(dto: ReunionDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'etatReunion?.libelle', header: 'Etat reunion'},
    ...
    public async loadEtatReunion(){
        this.etatReunionService.findAllOptimized().subscribe(etatReunions => this.etatReunions = etatReunions, error => console.log(error))
    }
	...
	public initDuplicate(res: ReunionDto) {
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Etat reunion': e.etatReunion?.libelle ,
            ...
            //'Etat reunion': this.criteria.etatReunion?.libelle ? this.criteria.etatReunion?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<ReunionDto> {
        return this.service.selections;
    }

    set selections(value: Array<ReunionDto>) {
