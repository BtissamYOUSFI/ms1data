...
@Component({
  selector: 'app-collaborateur-list-manager',
  standalone: false,
  templateUrl: './collaborateur-list-manager.component.html'
})
export class CollaborateurListManagerComponent implements OnInit {
    ...
    constructor( private service: CollaborateurManagerService  , @Inject(PLATFORM_ID) private platformId?) {
