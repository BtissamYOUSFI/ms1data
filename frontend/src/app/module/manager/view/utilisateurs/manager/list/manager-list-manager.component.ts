...
@Component({
  selector: 'app-manager-list-manager',
  standalone: false,
  templateUrl: './manager-list-manager.component.html'
})
export class ManagerListManagerComponent implements OnInit {

    protected fileName = 'Manager';
    ...
    constructor( private service: ManagerManagerService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ManagerDto>();
    ...
    public async edit(dto: ManagerDto) {
    ...
    public async view(dto: ManagerDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ManagerDto) {
    ...
    public async duplicate(dto: ManagerDto) {
    ...
    public exportPdf(dto: ManagerDto): void {
...
// add
	...
	public initDuplicate(res: ManagerDto) {
	}
    ...
    get items(): Array<ManagerDto> {
        return this.service.items;
    }

    set items(value: Array<ManagerDto>) {
        this.service.items = value;
    }

    get selections(): Array<ManagerDto> {
        return this.service.selections;
    }

    set selections(value: Array<ManagerDto>) {
    ...
    get criteria(): ManagerCriteria {
        return this.service.criteria;
    }

    set criteria(value: ManagerCriteria) {
