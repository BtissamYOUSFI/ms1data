...
@Component({
  selector: 'app-status-paiement-view-manager',
  standalone: false,
  templateUrl: './status-paiement-view-manager.component.html'
})
export class StatusPaiementViewManagerComponent implements OnInit {
    ...
    constructor(private service: StatusPaiementManagerService){
