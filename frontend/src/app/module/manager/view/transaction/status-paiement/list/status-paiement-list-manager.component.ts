...
@Component({
  selector: 'app-status-paiement-list-manager',
  standalone: false,
  templateUrl: './status-paiement-list-manager.component.html'
})
export class StatusPaiementListManagerComponent implements OnInit {
