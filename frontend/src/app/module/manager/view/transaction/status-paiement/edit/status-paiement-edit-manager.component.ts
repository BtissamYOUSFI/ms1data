...
@Component({
  selector: 'app-status-paiement-edit-manager',
  standalone: false,
  templateUrl: './status-paiement-edit-manager.component.html'
})
export class StatusPaiementEditManagerComponent implements OnInit {
