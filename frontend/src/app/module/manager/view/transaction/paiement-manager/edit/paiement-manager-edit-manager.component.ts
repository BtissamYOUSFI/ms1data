...
@Component({
  selector: 'app-paiement-manager-edit-manager',
  standalone: false,
  templateUrl: './paiement-manager-edit-manager.component.html'
})
export class PaiementManagerEditManagerComponent implements OnInit {
