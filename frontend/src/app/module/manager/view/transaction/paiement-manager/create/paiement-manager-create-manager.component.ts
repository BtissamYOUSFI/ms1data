...
@Component({
  selector: 'app-paiement-manager-create-manager',
  standalone: false,
  templateUrl: './paiement-manager-create-manager.component.html'
})
export class PaiementManagerCreateManagerComponent  implements OnInit {
