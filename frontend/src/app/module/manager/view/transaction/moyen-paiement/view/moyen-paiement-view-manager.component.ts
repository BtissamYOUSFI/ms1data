...
@Component({
  selector: 'app-moyen-paiement-view-manager',
  standalone: false,
  templateUrl: './moyen-paiement-view-manager.component.html'
})
export class MoyenPaiementViewManagerComponent implements OnInit {
    ...
    constructor(private service: MoyenPaiementManagerService){
