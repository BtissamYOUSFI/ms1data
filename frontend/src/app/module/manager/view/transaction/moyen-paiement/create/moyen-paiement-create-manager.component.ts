...
@Component({
  selector: 'app-moyen-paiement-create-manager',
  standalone: false,
  templateUrl: './moyen-paiement-create-manager.component.html'
})
export class MoyenPaiementCreateManagerComponent  implements OnInit {
