...
@Component({
  selector: 'app-moyen-paiement-list-manager',
  standalone: false,
  templateUrl: './moyen-paiement-list-manager.component.html'
})
export class MoyenPaiementListManagerComponent implements OnInit {
    ...
    constructor( private service: MoyenPaiementManagerService  , @Inject(PLATFORM_ID) private platformId?) {
