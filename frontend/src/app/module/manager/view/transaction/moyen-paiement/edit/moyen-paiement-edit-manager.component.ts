...
@Component({
  selector: 'app-moyen-paiement-edit-manager',
  standalone: false,
  templateUrl: './moyen-paiement-edit-manager.component.html'
})
export class MoyenPaiementEditManagerComponent implements OnInit {
