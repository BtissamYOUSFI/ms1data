...
@Component({
  selector: 'app-reunion-view-admin',
  templateUrl: './reunion-view-admin.component.html'
})
export class ReunionViewAdminComponent implements OnInit {
    ...
    constructor(private service: ReunionAdminService, private etatReunionService: EtatReunionAdminService, private collaborateurService: CollaborateurAdminService){
