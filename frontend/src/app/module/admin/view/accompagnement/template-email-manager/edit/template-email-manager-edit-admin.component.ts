...
@Component({
  selector: 'app-template-email-manager-edit-admin',
  standalone: false,
  templateUrl: './template-email-manager-edit-admin.component.html'
})
export class TemplateEmailManagerEditAdminComponent implements OnInit {
