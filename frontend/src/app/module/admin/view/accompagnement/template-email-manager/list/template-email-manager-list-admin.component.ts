...
@Component({
  selector: 'app-template-email-manager-list-admin',
  standalone: false,
  templateUrl: './template-email-manager-list-admin.component.html'
})
export class TemplateEmailManagerListAdminComponent implements OnInit {

    protected fileName = 'TemplateEmailManager';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TemplateEmailManagerDto>();
    ...
    public async edit(dto: TemplateEmailManagerDto) {
    ...
    public async view(dto: TemplateEmailManagerDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TemplateEmailManagerDto) {
    ...
    public async duplicate(dto: TemplateEmailManagerDto) {
    ...
    public exportPdf(dto: TemplateEmailManagerDto): void {
...
// add
	...
	public initDuplicate(res: TemplateEmailManagerDto) {
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            this.criteriaData = [{
                'Manager': this.criteria.manager ? this.criteria.manager : environment.emptyForExport ,
    ...
    get selections(): Array<TemplateEmailManagerDto> {
        return this.service.selections;
    }

    set selections(value: Array<TemplateEmailManagerDto>) {
