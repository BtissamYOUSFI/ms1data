...
@Component({
  selector: 'app-etat-reunion-view-admin',
  templateUrl: './etat-reunion-view-admin.component.html'
})
export class EtatReunionViewAdminComponent implements OnInit {
    ...
    constructor(private service: EtatReunionAdminService){
