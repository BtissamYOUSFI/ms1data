...
@Component({
  selector: 'app-template-email-collaborator-view-admin',
  standalone: false,
  templateUrl: './template-email-collaborator-view-admin.component.html'
})
export class TemplateEmailCollaboratorViewAdminComponent implements OnInit {
    ...
    constructor(private service: TemplateEmailCollaboratorAdminService){
