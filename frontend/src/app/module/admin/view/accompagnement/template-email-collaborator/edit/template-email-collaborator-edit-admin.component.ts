...
@Component({
  selector: 'app-template-email-collaborator-edit-admin',
  standalone: false,
  templateUrl: './template-email-collaborator-edit-admin.component.html'
})
export class TemplateEmailCollaboratorEditAdminComponent implements OnInit {
