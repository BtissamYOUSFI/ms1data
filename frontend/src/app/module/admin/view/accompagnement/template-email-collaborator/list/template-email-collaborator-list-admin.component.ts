...
@Component({
  selector: 'app-template-email-collaborator-list-admin',
  standalone: false,
  templateUrl: './template-email-collaborator-list-admin.component.html'
})
export class TemplateEmailCollaboratorListAdminComponent implements OnInit {

    protected fileName = 'TemplateEmailCollaborator';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TemplateEmailCollaboratorDto>();
    ...
    public async edit(dto: TemplateEmailCollaboratorDto) {
    ...
    public async view(dto: TemplateEmailCollaboratorDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TemplateEmailCollaboratorDto) {
    ...
    public async duplicate(dto: TemplateEmailCollaboratorDto) {
    ...
    public exportPdf(dto: TemplateEmailCollaboratorDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'collaborator', header: 'Collaborator'},
	...
	public initDuplicate(res: TemplateEmailCollaboratorDto) {
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            this.criteriaData = [{
                'Collaborator': this.criteria.collaborator ? this.criteria.collaborator : environment.emptyForExport ,
    ...
    get selections(): Array<TemplateEmailCollaboratorDto> {
        return this.service.selections;
    }

    set selections(value: Array<TemplateEmailCollaboratorDto>) {
