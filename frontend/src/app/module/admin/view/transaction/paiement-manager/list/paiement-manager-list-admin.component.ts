...
@Component({
  selector: 'app-paiement-manager-list-admin',
  standalone: false,
  templateUrl: './paiement-manager-list-admin.component.html'
})
export class PaiementManagerListAdminComponent implements OnInit {
