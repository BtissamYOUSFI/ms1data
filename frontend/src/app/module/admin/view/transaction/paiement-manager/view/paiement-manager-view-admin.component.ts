...
@Component({
  selector: 'app-paiement-manager-view-admin',
  standalone: false,
  templateUrl: './paiement-manager-view-admin.component.html'
})
export class PaiementManagerViewAdminComponent implements OnInit {
    ...
    constructor(private service: PaiementManagerAdminService, private moyenPaiementService: MoyenPaiementAdminService, private statusPaiementService: StatusPaiementAdminService, private managerService: ManagerAdminService){
