...
@Component({
  selector: 'app-paiement-manager-edit-admin',
  standalone: false,
  templateUrl: './paiement-manager-edit-admin.component.html'
})
export class PaiementManagerEditAdminComponent implements OnInit {
