...
@Component({
  selector: 'app-status-paiement-view-admin',
  templateUrl: './status-paiement-view-admin.component.html'
})
export class StatusPaiementViewAdminComponent implements OnInit {
    ...
    constructor(private service: StatusPaiementAdminService){
