...
@Component({
  selector: 'app-status-paiement-create-admin',
  templateUrl: './status-paiement-create-admin.component.html'
})
export class StatusPaiementCreateAdminComponent  implements OnInit {
