...
@Component({
  selector: 'app-status-paiement-edit-admin',
  templateUrl: './status-paiement-edit-admin.component.html'
})
export class StatusPaiementEditAdminComponent implements OnInit {
