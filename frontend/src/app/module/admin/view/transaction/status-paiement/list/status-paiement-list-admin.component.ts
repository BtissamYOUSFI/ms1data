...
@Component({
  selector: 'app-status-paiement-list-admin',
  templateUrl: './status-paiement-list-admin.component.html'
})
export class StatusPaiementListAdminComponent implements OnInit {
    ...
    constructor( private service: StatusPaiementAdminService  , @Inject(PLATFORM_ID) private platformId?) {
