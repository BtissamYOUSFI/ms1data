...
@Component({
  selector: 'app-referentiel-metier-view-admin',
  templateUrl: './referentiel-metier-view-admin.component.html'
})
export class ReferentielMetierViewAdminComponent implements OnInit {
    ...
    constructor(private service: ReferentielMetierAdminService, private metierService: MetierAdminService, private niveauLangueService: NiveauLangueAdminService, private langueService: LangueAdminService){
