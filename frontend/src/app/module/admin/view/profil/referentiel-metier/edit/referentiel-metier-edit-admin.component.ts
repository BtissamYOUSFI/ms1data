...
@Component({
  selector: 'app-referentiel-metier-edit-admin',
  templateUrl: './referentiel-metier-edit-admin.component.html'
})
export class ReferentielMetierEditAdminComponent implements OnInit {
