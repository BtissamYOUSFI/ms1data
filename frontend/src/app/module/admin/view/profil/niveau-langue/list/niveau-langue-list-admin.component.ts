...
@Component({
  selector: 'app-niveau-langue-list-admin',
  templateUrl: './niveau-langue-list-admin.component.html'
})
export class NiveauLangueListAdminComponent implements OnInit {

    protected fileName = 'NiveauLangue';
    ...
    constructor( private service: NiveauLangueAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<NiveauLangueDto>();
    ...
    public async edit(dto: NiveauLangueDto) {
    ...
    public async view(dto: NiveauLangueDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: NiveauLangueDto) {
    ...
    public async duplicate(dto: NiveauLangueDto) {
    ...
    public exportPdf(dto: NiveauLangueDto): void {
...
// add
	...
	public initDuplicate(res: NiveauLangueDto) {
	}
    ...
    get selections(): Array<NiveauLangueDto> {
        return this.service.selections;
    }

    set selections(value: Array<NiveauLangueDto>) {
