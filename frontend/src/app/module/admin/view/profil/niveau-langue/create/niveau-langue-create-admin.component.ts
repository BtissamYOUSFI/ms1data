...
@Component({
  selector: 'app-niveau-langue-create-admin',
  templateUrl: './niveau-langue-create-admin.component.html'
})
export class NiveauLangueCreateAdminComponent  implements OnInit {
