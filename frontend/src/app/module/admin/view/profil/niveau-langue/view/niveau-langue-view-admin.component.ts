...
@Component({
  selector: 'app-niveau-langue-view-admin',
  templateUrl: './niveau-langue-view-admin.component.html'
})
export class NiveauLangueViewAdminComponent implements OnInit {
    ...
    constructor(private service: NiveauLangueAdminService){
