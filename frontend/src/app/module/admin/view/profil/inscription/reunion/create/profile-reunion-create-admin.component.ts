...
@Component({
  selector: 'app-profile-reunion-create-admin',
  templateUrl: './profile-reunion-create-admin.component.html'
})
export class ProfileReunionCreateAdminComponent  implements OnInit {
   ...
   private _validReunionCode = true;
    ...
    ngOnInit(): void {
        ...
        this.etatReunionService.findAll().subscribe((data) => {
            ...
            this.item.etatReunion = this.etatReunions.find(e => e.libelle === 'Terminee');
        });
