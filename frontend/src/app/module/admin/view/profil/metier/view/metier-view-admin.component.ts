...
@Component({
  selector: 'app-metier-view-admin',
  templateUrl: './metier-view-admin.component.html'
})
export class MetierViewAdminComponent implements OnInit {
    ...
    constructor(private service: MetierAdminService){
