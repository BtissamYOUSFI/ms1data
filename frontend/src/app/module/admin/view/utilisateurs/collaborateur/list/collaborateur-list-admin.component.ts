...
export class CollaborateurListAdminComponent implements OnInit {
    ...
    constructor( private service: CollaborateurAdminService  , @Inject(PLATFORM_ID) private platformId?) {
