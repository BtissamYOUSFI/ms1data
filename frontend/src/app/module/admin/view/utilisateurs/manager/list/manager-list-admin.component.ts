...
@Component({
  selector: 'app-manager-list-admin',
  standalone: false,
  templateUrl: './manager-list-admin.component.html'
})
export class ManagerListAdminComponent implements OnInit {
    ...
    constructor( private service: ManagerAdminService  , @Inject(PLATFORM_ID) private platformId?) {
