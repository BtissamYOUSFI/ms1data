...
@Component({
  selector: 'app-register-collaborateur',
  templateUrl: './register-collaborateur.component.html',
  styleUrls: ['./register-collaborateur.component.css']
})
export class RegisterCollaborateurComponent implements OnInit {
    ...
    login() {
        this.router.navigate(['/collaborateur/login']);
    }
    ...
    submit() {
        ...
        if (this.registerDto.phone && this.registerDto.firstName && this.registerDto.lastName &&
            ...
            role.authority = 'ROLE_COLLABORATEUR';
            ...
            this.authService.registerCollaborateur();
