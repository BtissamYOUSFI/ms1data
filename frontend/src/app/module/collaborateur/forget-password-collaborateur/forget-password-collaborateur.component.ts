...
@Component({
    selector: 'app-forget-password-collaborateur',
    templateUrl: './forget-password-collaborateur.component.html',
    styleUrls: ['./forget-password-collaborateur.component.css'],
})
export class ForgetPasswordCollaborateurComponent {
    ...
    submit() {
        this.authService.sendForgetPasswordActivation(this.forgetPasswordDto.email).subscribe({
            next: () => {
                ...
                this.router.navigate(['collaborateur/changePassword'])
            },
