...
@Component({
  selector: 'app-activation-collaborateur',
  templateUrl: './activation-collaborateur.component.html',
  styleUrls: ['./activation-collaborateur.component.css']
})
export class ActivationCollaborateurComponent implements OnInit {
