...
@Component({
  selector: 'app-paiement-list-collaborateur',
  templateUrl: './paiement-list-collaborateur.component.html'
})
export class PaiementListCollaborateurComponent implements OnInit {

    protected fileName = 'Paiement';
    ...
    public async edit(dto: PaiementDto) {
    ...
    public async view(dto: PaiementDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: PaiementDto) {
    ...
    public async duplicate(dto: PaiementDto) {
    ...
    public exportPdf(dto: PaiementDto): void {
...
// add
    ...
    get selections(): Array<PaiementDto> {
        return this.service.selections;
    }

    set selections(value: Array<PaiementDto>) {
