...
@Component({
  selector: 'app-paiement-edit-collaborateur',
  templateUrl: './paiement-edit-collaborateur.component.html'
})
export class PaiementEditCollaborateurComponent implements OnInit {
