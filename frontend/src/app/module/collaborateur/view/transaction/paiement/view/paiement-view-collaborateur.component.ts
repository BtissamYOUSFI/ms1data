...
@Component({
  selector: 'app-paiement-view-collaborateur',
  templateUrl: './paiement-view-collaborateur.component.html'
})
export class PaiementViewCollaborateurComponent implements OnInit {
    ...
    constructor(private service: PaiementCollaborateurService, private moyenPaiementService: MoyenPaiementCollaborateurService, private statusPaiementService: StatusPaiementCollaborateurService){
