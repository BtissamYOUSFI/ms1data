                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: StatusPaiementListCollaborateurComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: PaiementListCollaborateurComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: MoyenPaiementListCollaborateurComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class TransactionCollaborateurRoutingModule { }
