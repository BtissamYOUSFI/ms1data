...
@Component({
  selector: 'app-moyen-paiement-create-collaborateur',
  templateUrl: './moyen-paiement-create-collaborateur.component.html'
})
export class MoyenPaiementCreateCollaborateurComponent  implements OnInit {
