...
@Component({
  selector: 'app-moyen-paiement-view-collaborateur',
  templateUrl: './moyen-paiement-view-collaborateur.component.html'
})
export class MoyenPaiementViewCollaborateurComponent implements OnInit {
    ...
    constructor(private service: MoyenPaiementCollaborateurService){
