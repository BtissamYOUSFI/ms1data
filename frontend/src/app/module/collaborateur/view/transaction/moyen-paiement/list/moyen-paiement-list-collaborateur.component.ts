...
@Component({
  selector: 'app-moyen-paiement-list-collaborateur',
  templateUrl: './moyen-paiement-list-collaborateur.component.html'
})
export class MoyenPaiementListCollaborateurComponent implements OnInit {

    protected fileName = 'MoyenPaiement';
    ...
    constructor( private service: MoyenPaiementCollaborateurService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<MoyenPaiementDto>();
    ...
    public async edit(dto: MoyenPaiementDto) {
    ...
    public async view(dto: MoyenPaiementDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: MoyenPaiementDto) {
    ...
    public async duplicate(dto: MoyenPaiementDto) {
    ...
    public exportPdf(dto: MoyenPaiementDto): void {
...
// add
    ...
    get selections(): Array<MoyenPaiementDto> {
        return this.service.selections;
    }

    set selections(value: Array<MoyenPaiementDto>) {
