...
@Component({
  selector: 'app-moyen-paiement-edit-collaborateur',
  templateUrl: './moyen-paiement-edit-collaborateur.component.html'
})
export class MoyenPaiementEditCollaborateurComponent implements OnInit {
