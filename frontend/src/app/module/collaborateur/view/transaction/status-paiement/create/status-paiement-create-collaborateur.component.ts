...
@Component({
  selector: 'app-status-paiement-create-collaborateur',
  templateUrl: './status-paiement-create-collaborateur.component.html'
})
export class StatusPaiementCreateCollaborateurComponent  implements OnInit {
