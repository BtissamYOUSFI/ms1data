...
@Component({
  selector: 'app-status-paiement-list-collaborateur',
  templateUrl: './status-paiement-list-collaborateur.component.html'
})
export class StatusPaiementListCollaborateurComponent implements OnInit {

    protected fileName = 'StatusPaiement';
    ...
    constructor( private service: StatusPaiementCollaborateurService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<StatusPaiementDto>();
    ...
    public async edit(dto: StatusPaiementDto) {
    ...
    public async view(dto: StatusPaiementDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: StatusPaiementDto) {
    ...
    public async duplicate(dto: StatusPaiementDto) {
    ...
    public exportPdf(dto: StatusPaiementDto): void {
...
// add
	...
	public initDuplicate(res: StatusPaiementDto) {
	}
    ...
    get selections(): Array<StatusPaiementDto> {
        return this.service.selections;
    }

    set selections(value: Array<StatusPaiementDto>) {
