...
@Component({
  selector: 'app-status-paiement-edit-collaborateur',
  templateUrl: './status-paiement-edit-collaborateur.component.html'
})
export class StatusPaiementEditCollaborateurComponent implements OnInit {
