...
@Component({
  selector: 'app-status-paiement-view-collaborateur',
  templateUrl: './status-paiement-view-collaborateur.component.html'
})
export class StatusPaiementViewCollaborateurComponent implements OnInit {
    ...
    constructor(private service: StatusPaiementCollaborateurService){
