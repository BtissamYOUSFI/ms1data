...
@Component({
  selector: 'app-collaborateur-list-collaborateur',
  templateUrl: './collaborateur-list-collaborateur.component.html'
})
export class CollaborateurListCollaborateurComponent implements OnInit {

    protected fileName = 'Collaborateur';
    ...
    constructor( private service: CollaborateurCollaborateurService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CollaborateurDto>();
    ...
    public async edit(dto: CollaborateurDto) {
    ...
    public async view(dto: CollaborateurDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async openCreate() {
        this.item = new CollaborateurDto();
    ...
    public async delete(dto: CollaborateurDto) {
    ...
    public async duplicate(dto: CollaborateurDto) {
    ...
    public exportPdf(dto: CollaborateurDto): void {
...
// add
    ...
    get items(): Array<CollaborateurDto> {
        return this.service.items;
    }

    set items(value: Array<CollaborateurDto>) {
        this.service.items = value;
    }

    get selections(): Array<CollaborateurDto> {
        return this.service.selections;
    }

    set selections(value: Array<CollaborateurDto>) {
        this.service.selections = value;
    }

    get item(): CollaborateurDto {
        return this.service.item;
    }

    set item(value: CollaborateurDto) {
    ...
    get criteria(): CollaborateurCriteria {
        return this.service.criteria;
    }

    set criteria(value: CollaborateurCriteria) {
