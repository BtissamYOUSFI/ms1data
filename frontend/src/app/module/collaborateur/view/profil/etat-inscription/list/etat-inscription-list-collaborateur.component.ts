...
@Component({
  selector: 'app-etat-inscription-list-collaborateur',
  templateUrl: './etat-inscription-list-collaborateur.component.html'
})
export class EtatInscriptionListCollaborateurComponent implements OnInit {

    protected fileName = 'EtatInscription';
    ...
    constructor( private service: EtatInscriptionCollaborateurService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EtatInscriptionDto>();
    ...
    public async edit(dto: EtatInscriptionDto) {
    ...
    public async view(dto: EtatInscriptionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EtatInscriptionDto) {
    ...
    public async duplicate(dto: EtatInscriptionDto) {
    ...
    public exportPdf(dto: EtatInscriptionDto): void {
...
// add
    ...
    get selections(): Array<EtatInscriptionDto> {
        return this.service.selections;
    }

    set selections(value: Array<EtatInscriptionDto>) {
