...
@Component({
  selector: 'app-etat-inscription-create-collaborateur',
  templateUrl: './etat-inscription-create-collaborateur.component.html'
})
export class EtatInscriptionCreateCollaborateurComponent  implements OnInit {
