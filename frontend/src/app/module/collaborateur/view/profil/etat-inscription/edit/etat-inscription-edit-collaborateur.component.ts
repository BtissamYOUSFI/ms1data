...
@Component({
  selector: 'app-etat-inscription-edit-collaborateur',
  templateUrl: './etat-inscription-edit-collaborateur.component.html'
})
export class EtatInscriptionEditCollaborateurComponent implements OnInit {
