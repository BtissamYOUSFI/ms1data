...
@Component({
  selector: 'app-inscription-create-collaborateur',
  templateUrl: './inscription-create-collaborateur.component.html'
})
export class InscriptionCreateCollaborateurComponent  implements OnInit {
