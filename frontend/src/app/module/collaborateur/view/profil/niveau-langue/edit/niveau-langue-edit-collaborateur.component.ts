...
@Component({
  selector: 'app-niveau-langue-edit-collaborateur',
  templateUrl: './niveau-langue-edit-collaborateur.component.html'
})
export class NiveauLangueEditCollaborateurComponent implements OnInit {
