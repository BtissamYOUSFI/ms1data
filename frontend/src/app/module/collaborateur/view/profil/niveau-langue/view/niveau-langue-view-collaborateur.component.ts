...
@Component({
  selector: 'app-niveau-langue-view-collaborateur',
  templateUrl: './niveau-langue-view-collaborateur.component.html'
})
export class NiveauLangueViewCollaborateurComponent implements OnInit {
    ...
    constructor(private service: NiveauLangueCollaborateurService){
