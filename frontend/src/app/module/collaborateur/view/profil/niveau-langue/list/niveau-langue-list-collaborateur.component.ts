...
@Component({
  selector: 'app-niveau-langue-list-collaborateur',
  templateUrl: './niveau-langue-list-collaborateur.component.html'
})
export class NiveauLangueListCollaborateurComponent implements OnInit {
