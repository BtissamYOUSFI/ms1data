...
@Component({
  selector: 'app-referentiel-metier-edit-collaborateur',
  templateUrl: './referentiel-metier-edit-collaborateur.component.html'
})
export class ReferentielMetierEditCollaborateurComponent implements OnInit {
    ...
    constructor(private service: ReferentielMetierCollaborateurService , private metierService: MetierCollaborateurService, private niveauLangueService: NiveauLangueCollaborateurService, private langueService: LangueCollaborateurService, @Inject(PLATFORM_ID) private platformId?) {
