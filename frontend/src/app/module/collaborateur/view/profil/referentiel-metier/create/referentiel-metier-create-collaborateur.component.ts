...
@Component({
  selector: 'app-referentiel-metier-create-collaborateur',
  templateUrl: './referentiel-metier-create-collaborateur.component.html'
})
export class ReferentielMetierCreateCollaborateurComponent  implements OnInit {
