...
@Component({
  selector: 'app-referentiel-metier-list-collaborateur',
  templateUrl: './referentiel-metier-list-collaborateur.component.html'
})
export class ReferentielMetierListCollaborateurComponent implements OnInit {
