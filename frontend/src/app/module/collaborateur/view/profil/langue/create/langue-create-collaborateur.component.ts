...
@Component({
  selector: 'app-langue-create-collaborateur',
  templateUrl: './langue-create-collaborateur.component.html'
})
export class LangueCreateCollaborateurComponent  implements OnInit {
