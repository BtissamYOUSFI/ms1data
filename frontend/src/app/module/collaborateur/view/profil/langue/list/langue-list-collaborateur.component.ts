...
@Component({
  selector: 'app-langue-list-collaborateur',
  templateUrl: './langue-list-collaborateur.component.html'
})
export class LangueListCollaborateurComponent implements OnInit {

    protected fileName = 'Langue';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<LangueDto>();
    ...
    public async edit(dto: LangueDto) {
    ...
    public async view(dto: LangueDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: LangueDto) {
    ...
    public async duplicate(dto: LangueDto) {
    ...
    public exportPdf(dto: LangueDto): void {
...
// add
    ...
    get selections(): Array<LangueDto> {
        return this.service.selections;
    }

    set selections(value: Array<LangueDto>) {
