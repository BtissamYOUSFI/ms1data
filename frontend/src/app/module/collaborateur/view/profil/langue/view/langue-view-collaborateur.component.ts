...
@Component({
  selector: 'app-langue-view-collaborateur',
  templateUrl: './langue-view-collaborateur.component.html'
})
export class LangueViewCollaborateurComponent implements OnInit {
    ...
    constructor(private service: LangueCollaborateurService){
