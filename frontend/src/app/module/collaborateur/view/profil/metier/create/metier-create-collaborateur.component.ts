...
@Component({
  selector: 'app-metier-create-collaborateur',
  templateUrl: './metier-create-collaborateur.component.html'
})
export class MetierCreateCollaborateurComponent  implements OnInit {
