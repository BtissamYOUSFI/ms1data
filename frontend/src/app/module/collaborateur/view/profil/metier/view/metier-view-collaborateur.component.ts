...
@Component({
  selector: 'app-metier-view-collaborateur',
  templateUrl: './metier-view-collaborateur.component.html'
})
export class MetierViewCollaborateurComponent implements OnInit {
    ...
    constructor(private service: MetierCollaborateurService){
