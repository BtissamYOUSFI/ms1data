...
@Component({
  selector: 'app-metier-list-collaborateur',
  templateUrl: './metier-list-collaborateur.component.html'
})
export class MetierListCollaborateurComponent implements OnInit {

    protected fileName = 'Metier';
    ...
    constructor( private service: MetierCollaborateurService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<MetierDto>();
    ...
    public async edit(dto: MetierDto) {
    ...
    public async view(dto: MetierDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: MetierDto) {
    ...
    public async duplicate(dto: MetierDto) {
    ...
    public exportPdf(dto: MetierDto): void {
...
// add
	...
	public initDuplicate(res: MetierDto) {
	}
    ...
    get selections(): Array<MetierDto> {
        return this.service.selections;
    }

    set selections(value: Array<MetierDto>) {
