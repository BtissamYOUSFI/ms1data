...
@Component({
  selector: 'app-metier-edit-collaborateur',
  templateUrl: './metier-edit-collaborateur.component.html'
})
export class MetierEditCollaborateurComponent implements OnInit {
