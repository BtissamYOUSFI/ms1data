...
@Component({
  selector: 'app-reunion-list-collaborateur',
  templateUrl: './reunion-list-collaborateur.component.html'
})
export class ReunionListCollaborateurComponent implements OnInit {
    ...
    constructor( private service: ReunionCollaborateurService  , private etatReunionService: EtatReunionCollaborateurService, private collaborateurService: CollaborateurCollaborateurService, @Inject(PLATFORM_ID) private platformId?) {
