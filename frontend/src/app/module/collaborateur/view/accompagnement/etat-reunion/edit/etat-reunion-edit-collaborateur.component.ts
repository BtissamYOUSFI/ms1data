...
@Component({
  selector: 'app-etat-reunion-edit-collaborateur',
  templateUrl: './etat-reunion-edit-collaborateur.component.html'
})
export class EtatReunionEditCollaborateurComponent implements OnInit {
