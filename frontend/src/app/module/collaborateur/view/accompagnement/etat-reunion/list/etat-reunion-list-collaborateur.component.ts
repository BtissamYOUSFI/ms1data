...
@Component({
  selector: 'app-etat-reunion-list-collaborateur',
  templateUrl: './etat-reunion-list-collaborateur.component.html'
})
export class EtatReunionListCollaborateurComponent implements OnInit {

    protected fileName = 'EtatReunion';
    ...
    constructor( private service: EtatReunionCollaborateurService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EtatReunionDto>();
    ...
    public async edit(dto: EtatReunionDto) {
    ...
    public async view(dto: EtatReunionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EtatReunionDto) {
    ...
    public async duplicate(dto: EtatReunionDto) {
    ...
    public exportPdf(dto: EtatReunionDto): void {
...
// add
	...
	public initDuplicate(res: EtatReunionDto) {
	}
    ...
    get selections(): Array<EtatReunionDto> {
        return this.service.selections;
    }

    set selections(value: Array<EtatReunionDto>) {
