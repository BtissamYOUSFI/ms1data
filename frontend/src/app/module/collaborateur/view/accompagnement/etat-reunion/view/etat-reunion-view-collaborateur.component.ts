...
@Component({
  selector: 'app-etat-reunion-view-collaborateur',
  templateUrl: './etat-reunion-view-collaborateur.component.html'
})
export class EtatReunionViewCollaborateurComponent implements OnInit {
    ...
    constructor(private service: EtatReunionCollaborateurService){
