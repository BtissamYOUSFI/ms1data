...
@Component({
  selector: 'app-change-password-collaborateur',
  templateUrl: './change-password-collaborateur.component.html',
  styleUrls: ['./change-password-collaborateur.component.css']
})
export class ChangePasswordCollaborateurComponent implements OnInit {
