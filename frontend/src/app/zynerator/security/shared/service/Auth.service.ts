...
export class AuthService {
    ...
    */
    ...
    public registerCollaborateur() {
        this.register(this.registerUrl + 'collaborateur', 'ROLE_COLLABORATEUR', '/collaborateur/activation')
    }
            ...
            .pipe(
                map(resp => {
                    if (this.user.roleUsers[0].role.authority === 'ADMIN') {
                        ...
                        else if (this.user.roleUsers[0].role.authority === 'COLLABORATEUR') {
